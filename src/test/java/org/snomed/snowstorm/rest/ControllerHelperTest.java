...
public class ControllerHelperTest {
	...
	public void getPageRequestZero() throws Exception {
		AbstractPageRequest pageRequest = ControllerHelper.getPageRequest(0, 100);
	...
	public void getPageRequestOne() throws Exception {
		AbstractPageRequest pageRequest = ControllerHelper.getPageRequest(100, 100);
	...
	public void getPageRequestTwo() throws Exception {
		AbstractPageRequest pageRequest = ControllerHelper.getPageRequest(200, 100);
